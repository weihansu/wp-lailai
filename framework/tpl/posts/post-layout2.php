        ...
        <div class="part-left">
            <div class="gallery-thumb">
                ...
                foreach (rwmb_meta('dsk_post_gallery', 'type=image') as $image) { ?>
                    <?php 
                    $src = $image['full_url'];
                    if ( $image['sizes']['dsk_blog_large_thumb']['file'] ) {
                        $src = str_replace($image['name'], $image['sizes']['dsk_blog_large_thumb']['file'], $image['full_url']);
                    }
                    ?>
